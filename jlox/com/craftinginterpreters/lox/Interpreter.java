...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitLiteralExpr(Expr.Literal expr) {
        return expr.value; // parser already put this value in AST node
    }
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        // look up surrounding class' superclass by looking up "super" in proper environment
    ...
    private Object lookUpVariable(Token name, Expr expr) {
        Integer distance = locals.get(expr); // number of scopes out that the variable was defined
        if (distance != null) {
    ...
    private String stringify(Object object) {
        ...
        // hack - work around java's adding of ".0" to int-valued doubles
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        LoxFunction function = new LoxFunction(stmt, environment, false); // runtime fn representation which wraps Stmt.Function syntax node
